...
public class ATSScenarioLoader {
    ...
    public static List<ATSScenarioData> loadAllScenarios() {
        ...
        String[] scenarioFiles = {
            ...
            "scenario-25-anderson-hsa.json",
            "scenario-26-clark-foreign.json",
            "scenario-27-moore-energy.json",
            "scenario-28-taylor-qbi.json",
            "scenario-29-white-k1.json",
            "scenario-30-harris-unemployment.json",
            "scenario-31-jackson-gambling.json",
            "scenario-32-chen-ev.json",
            "scenario-33-wright-amt.json",
